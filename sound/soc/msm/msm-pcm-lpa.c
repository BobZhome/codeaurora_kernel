...
static struct snd_pcm_hardware msm_pcm_hardware = {
	...
	.channels_min =         1,
	.channels_max =         2,
	.buffer_bytes_max =     1024 * 1024,// LGE_CHANGE_S, [G1_Player][nikech.choi@lge.com], 20120410, QCT patch for fixing chopping noise issue(with BT headset)
/* TODO: Check on the lowest period size we can support */
	.period_bytes_min =	128 * 1024,
	.period_bytes_max =     256 * 1024,// LGE_CHANGE_S, [G1_Player][nikech.choi@lge.com], 20120410, QCT patch for fixing chopping noise issue(with BT headset)
	.periods_min =          4,
	.periods_max =          8,// LGE_CHANGE_S, [G1_Player][nikech.choi@lge.com], 20120410, QCT patch for fixing chopping noise issue(with BT headset)
	.fifo_size =            0,
};

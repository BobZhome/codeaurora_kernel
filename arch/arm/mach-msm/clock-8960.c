...
static struct clk_lookup msm_clocks_8960[] = {
	CLK_LOOKUP("xo",		cxo_a_clk.c,	""),
	CLK_LOOKUP("xo",		pxo_a_clk.c,	""),
#ifndef CONFIG_MMC_MSM_SDC4_SUPPORT	//20120702 ws.yang@lge.com : do not use..
	CLK_LOOKUP("cxo",		cxo_clk.c,	"wcnss_wlan.0"),
#endif
	CLK_LOOKUP("cxo",		cxo_clk.c,	"pil_riva"),
	CLK_LOOKUP("xo",		pxo_clk.c,	"pil_qdsp6v4.0"),
...
/*  20111205, chaeuk.lee@lge.com, Add IrDA UART [START] */
	...
	CLK_LOOKUP("core_clk",		gsbi9_uart_clk.c, "msm_serial_hs1.2"),
...
#if defined(CONFIG_MSM_CAMERA_FLASH_LM3559) || defined(CONFIG_LGE_NFC_PN544_C2)
	CLK_LOOKUP("core_clk",		gsbi7_qup_clk.c,	"qup_i2c.7"),
#else
	CLK_LOOKUP("core_clk",		gsbi7_qup_clk.c,	""),
#endif
//20111124, dongjoon.kim@lge.com, Rev.C NFC I2C : GSBI 7 --> GSBI8
#if defined(CONFIG_MSM_CAMERA_FLASH_LM3559) || defined(CONFIG_LGE_NFC_PN544_C2)|| defined(CONFIG_LGE_FELICA)
...
#if defined(CONFIG_LGE_NFC_PN544_C2) || defined(CONFIG_MSM_CAMERA_FLASH_LM3559) || defined(CONFIG_LGE_FELICA)
#ifdef CONFIG_LGE_FELICA
...
#if defined (CONFIG_MACH_MSM8960_D1LV) || defined (CONFIG_MACH_MSM8960_D1LA)

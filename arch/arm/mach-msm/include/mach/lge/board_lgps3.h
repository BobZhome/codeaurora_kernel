...
#ifndef _BOARD_LGPS3_H_
#define _BOARD_LGPS3_H_
...
#define USB_SERIAL_NUMBER						"LGE_ANDROID_LGPS3_DEV"
#define TS_X_MIN								0
#define TS_X_MAX								720
#define TS_Y_MIN								0
...
#define MAX17043_FUELGAUGE_GPIO_IRQ				40
...
/* MHL GPIOs */
#define MHL_PWR_EN								43 /* used in lgps3 */
...
/* Camera */
/* #define USE_INT_MCLK1 */
#define GPIO_CAM_MCLK0          (5)
#ifdef USE_INT_MCLK1
#define GPIO_CAM_MCLK1          (4)
#endif
#define GPIO_VT_MCLK_EN         (54)
#define GPIO_CAM_VCM_EN         (3)
...
#define I2C_SLAVE_ADDR_CAM1     (0x34 >> 2)
#define I2C_SLAVE_ADDR_CAM2     (0x6E)
...
#define VFE_CAMIF_TIMER1_GPIO 0

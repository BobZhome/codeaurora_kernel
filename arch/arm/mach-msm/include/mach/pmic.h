...
#define HS_LED_COLOR_OFF   0
#define HS_LED_COLOR_BLUE  1
#define HS_LED_COLOR_GREEN 2
#define HS_LED_COLOR_RED   4

#define HS_LED_FLASH_ON    1
#define HS_LED_FLASH_OFF   0

#define HS_LED_PRIORITY_BT_INCOMING      0
#define HS_LED_PRIORITY_INCOMING         1
#define HS_LED_PRIORITY_DATAROAMGUARD    2
#define HS_LED_PRIORITY_NOTIFICATION     3
#define HS_LED_PRIORITY_BATTERY          4
#define HS_LED_PRIORITY_NUMBER           5

#define HS_LED_CTRL_MAX_SEQUENCE          10

struct pm_oem_led_control_data {
	uint32_t	Priority;
	uint32_t	Color;
	uint32_t	Mode;
	uint32_t	Pattern[HS_LED_CTRL_MAX_SEQUENCE];
};

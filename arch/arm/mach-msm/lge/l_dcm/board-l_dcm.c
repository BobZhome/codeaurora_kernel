...
static struct msm_serial_hslite_platform_data msm8960_uart_gsbi8_pdata = {
	.config_gpio	= 1,
	.uart_tx_gpio	= 34,
	.uart_rx_gpio	= 35,
};
...
static struct msm_serial_hslite_platform_data msm8960_irda_gsbi9_pdata = {
	.config_gpio	= 1,
	.uart_tx_gpio	= 93,
	.uart_rx_gpio	= 94,
};
 ...
 */
	...
	if(machine_is_msm8960_l_dcm()) {
		...
		writel_relaxed(GSBI_DUAL_MODE_CODE, gsbi8_mem);
		mb();
		iounmap(gsbi8_mem);
 ...
 */
	...
	if(machine_is_msm8960_l_dcm()) {
		...
		void *gsbi9_mem = ioremap_nocache(MSM_GSBI9_PHYS, 4);
		writel_relaxed(GSBI_DUAL_MODE_CODE, gsbi9_mem);
		mb();
		iounmap(gsbi9_mem);
 ...
 */
	...
	msm8960_device_qup_i2c_gsbi8.dev.platform_data = &msm8960_i2c_qup_gsbi8_pdata;
#endif
...
MACHINE_START(MSM8960_L_DCM, "LGE MSM8960 L_DCM")

...
/* Improve : Unnormal battery, 20120905, sungsoo77.kim@lge.com*/
#if defined(CONFIG_LGE_PM_435V_BATT) 
#define MAX_VOLTAGE_MV		4350
#define CHG_TERM_MA		200							/*20120905 Required to correct the charging cutoff current*/
static struct pm8921_charger_platform_data pm8921_chg_pdata __devinitdata = {
	.safety_time			= 480,
	.update_time			= 60000,
	.max_voltage			= MAX_VOLTAGE_MV,
	.min_voltage			= 3300,					/*20120903 corret for test*/
...
/* BEGIN : jooyeong.lee@lge.com 2012-02-27 Change the charger_temp_scenario */
	.temp_level_1		= 57, /*MS870 HW's req : 55 -> 57*/
	.temp_level_2		= 47, /*MS870 HW's req : 45 -> 47*/
	.temp_level_3		= 46, /*MS870 HW's req : 42 -> 46*/
	.temp_level_4		= -6, /*MS870 HW's req : -5 -> -6*/
	.temp_level_5		= -8, /*MS870 HW's req :-10 -> -8*/
...
#endif
	.weak_voltage		= 3300,					/*20120903 correct for test*/
	.weak_current		= 325,
};
/*#else *20120905 sungsoo77.kim@lge.com - Add for the charging senario of a unnormal battery */
#define MAX_VOLTAGE_MV_unnormal		4150
#define CHG_TERM_MA_unnormal		200
static struct pm8921_charger_platform_data pm8921_chg_pdata_unnormal __devinitdata = {
	.safety_time			= 480,
	.update_time			= 60000,
	.max_voltage			= MAX_VOLTAGE_MV_unnormal,
	.min_voltage			= 3300,
	.resume_voltage_delta	= 100,
	.term_current			= CHG_TERM_MA_unnormal,
#ifdef CONFIG_LGE_CHARGER_TEMP_SCENARIO
	.cool_temp			= 0,					
	.warm_temp			= 0,
/* BEGIN : jooyeong.lee@lge.com 2012-02-27 Change the charger_temp_scenario */
...
#else
	.cool_temp		= 0,
	.warm_temp		= 45,						/*20120903 correct 40 -> 45*/
#endif
	.temp_check_period		= 1,
	.max_bat_chg_current	= IBAT_CURRENT,
	.cool_bat_chg_current	= 350,
...
static struct pm8921_bms_platform_data pm8921_bms_pdata __devinitdata = {
	...
	.r_sense					= 10,
	.v_cutoff					= 3300,						/*20120903 correct for test*/
...
/* START : sungsoo77.kim@lge.com 2012-08-31 delete Quickstart for Test Mode and SOC Accurency */
/* Accepted to choies LGC & Sanyo common Rcomp */
...
/*END : sungsoo77.kim@lge.com 2012-08-31*/
...
/* 20120905 sungsoo77.kim@lge.com - Accepted the charging senario of a unnormal battery */

void __init msm8960_init_pmic(void)
{
#if defined(CONFIG_MACH_MSM8960_L1m)
	struct pm8921_platform_data *pdata;
	pdata = (struct pm8921_platform_data *)msm8960_ssbi_pm8921_pdata.slave.platform_data;
#endif	
	pmic_reset_irq = PM8921_IRQ_BASE + PM8921_RESOUT_IRQ;
	msm8960_device_ssbi_pmic.dev.platform_data =
				&msm8960_ssbi_pm8921_pdata;
#if defined(CONFIG_MACH_MSM8960_L1m)
	if(lge_battery_info != BATT_DS2704_L && lge_battery_info != BATT_ISL6296_L)
		pdata ->charger_pdata = &pm8921_chg_pdata_unnormal;
#endif

...
static struct gpiomux_setting gsbi4_irrc= {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
	
static struct gpiomux_setting gsbi4_irrc_active = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
/* 20120704, sukkkong.kim@lge.com, Add IRRC UART [START] */
#ifdef CONFIG_LGE_IRRC
static struct msm_gpiomux_config msm8960_irrc_configs[] __initdata = {
	{
		.gpio	   = 18,	/* GSBI4 UART */
		.settings = {
			[GPIOMUX_ACTIVE]	= &gsbi4_irrc_active,
			[GPIOMUX_SUSPENDED] = &gsbi4_irrc,
		},
	},
	{
		.gpio	   = 19,	/* GSBI4 UART */
...
/* 20120704, sukkkong.kim@lge.com, Add IrRC UART [START] */
#ifdef CONFIG_LGE_IRRC
	msm_gpiomux_install(msm8960_irrc_configs,
 	        ARRAY_SIZE(msm8960_irrc_configs));
#endif
/* 20120704, sukkkong.kim@lge.com, Add IrRC UART [END] */

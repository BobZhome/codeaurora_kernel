...
static void __init msm8960_early_memory(void)
{
	...
	printk("msm8960_early_memory start..\n");
// QCT PATCH START	
	adjust_memory_overflow();
// QCT PATCH END	
	locate_unstable_memory();
	place_movable_zone();
	printk("msm8960_early_memory end..\n");	
}
...
#ifdef CONFIG_LGE_IRRC //amtel_wondol test
	{
...
#if defined(CONFIG_LGE_NFC_PN544_C2) || defined(CONFIG_MSM_CAMERA_FLASH_LM3559)
...
MACHINE_START(MSM8960_D1L_KR, "LGE MSM8960 D1L KR")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.handle_irq = gic_handle_irq,

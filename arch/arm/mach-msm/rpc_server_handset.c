...
#define HS_LINE_SPEAKER_K 0xFD
#define HS_LINE_SPEAKER   0xFD
#endif
...
#ifdef FEATURE_KYOCERA_MSND
	KEY(HS_LINE_SPEAKER_K, HS_LINE_SPEAKER),
#endif
	0
};
 ...
 */
#ifdef FEATURE_KYOCERA_MSND
extern void msm_snddev_poweramp_on(void);
extern void msm_snddev_poweramp_off(void);
#endif

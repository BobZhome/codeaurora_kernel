 ...
 * MSM_GSBI4_PHYS + 0x0 : GSBI Control register base
 * MSM_GSBI4_PHYS + 0x40000 : UART_DM register base
 * MSM_GSBI4_PHYS + 0x80000 : QUP register base
 */
...
static struct fs_driver_data mdp_fs_data = {
	.clks = (struct fs_clk_data[]){
		...
		{ .name = "vsync_clk" },
		{ .name = "lut_clk" },
//20120806 hyeongwoo.seo@lge.com  Feature Added - fixed footswitch_probe failure

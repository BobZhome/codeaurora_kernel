...
/*LGE_CHANGE_S: kiran.kanneganti@lge.com. 02-nov-2012*/
#ifdef CONFIG_MACH_LGE
		goto cmd_err;
#else
		goto cmd_done;
#endif
/*LGE_CHANGE_E: kiran.kanneganti@lge.com. 02-nov-2012*/
	}
...
#if 0 /* Remove use of mmc_blk_set_blksize, for remove 300mese delay in case of normal SD cards ( CSD Version 1.0  Standard Capacity ) */
static int

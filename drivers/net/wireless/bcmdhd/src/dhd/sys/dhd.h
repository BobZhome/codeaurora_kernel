...
#define POWERUP_MAX_RETRY	(5) /* 10times is too much so reducd 5 time retry for factory */
#endif
...
#if defined (CUSTOMER_HW4) && defined (CONFIG_DHD_USE_STATIC_BUF)
...
inline static void MUTEX_LOCK_STARTSTOP_SET_INIT(dhd_pub_t * dhdp)
{
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 25)) && 1
...
inline static void MUTEX_LOCK_STARTSTOP_SET(dhd_pub_t * dhdp)
{
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 25)) && 1
...
inline static void MUTEX_UNLOCK_STARTSTOP_SET(dhd_pub_t * dhdp)
{
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 25)) && 1

...
struct ts_info_classdev {
	const char		*name;
#if defined(CONFIG_TOUCHSCREEN_S3200_SYNAPTICS_TS) || defined(CONFIG_USING_INNOTEK_PANEL_4_7) || defined(CONFIG_MACH_MSM8960_L1m) || defined(CONFIG_MACH_MSM8960_L1v)
	char			*version;
#else
	int			 version;
#endif

...
#if defined(CONFIG_MACH_MSM8960_L1u) || defined(CONFIG_MACH_MSM8960_L1sk) || defined(CONFIG_MACH_MSM8960_L1kt) || defined(LGU_TOUCH)
extern unsigned short MELFAS_binary_nLength_L1u_1;
extern unsigned char MELFAS_binary_L1u_1[];
extern unsigned short MELFAS_binary_nLength_L1u_2;
extern unsigned char MELFAS_binary_L1u_2[];
#endif
...
#if defined(CONFIG_MACH_MSM8960_L1m) || defined(CONFIG_MACH_MSM8960_L1v)
        ts->version[0] = (char)verbuf[FW_VERSION_ADDR];
...
#if defined(CONFIG_MACH_MSM8960_L1m) || defined(CONFIG_MACH_MSM8960_L1v)
		ts->version[0] = verbuf[FW_VERSION_ADDR];
#else
		ts->version = verbuf[FW_VERSION_ADDR];
#endif
...
//#define LGU_TOUCH		// temp for L1 lgu+
...
//			ts->pdata->fw_ver = 0xa5;
//		} else {
//			MELFAS_binary_nLength = MELFAS_binary_nLength_2;
//			MELFAS_binary = MELFAS_binary_2;
//		}
/*  d1lkr*/
#if defined(CONFIG_USING_INNOTEK_PANEL_4_5) /* l1u */
		{
#if defined(CONFIG_MACH_MSM8960_L1u) || defined(CONFIG_MACH_MSM8960_L1sk) || defined(CONFIG_MACH_MSM8960_L1kt) || defined(LGU_TOUCH)
		if (lge_get_board_revno() <= HW_REV_B) {
			MELFAS_binary_nLength = MELFAS_binary_nLength_L1u_1;
			MELFAS_binary = MELFAS_binary_L1u_1;
			ts->pdata->fw_ver = 3;
		} else {
			MELFAS_binary_nLength = MELFAS_binary_nLength_L1u_2;
			MELFAS_binary = MELFAS_binary_L1u_2;
		}
#else
			MELFAS_binary_nLength = MELFAS_binary_nLength_1;
			MELFAS_binary = MELFAS_binary_1;
...
#if defined(CONFIG_MACH_MSM8960_L1m) || defined(CONFIG_MACH_MSM8960_L1v)
	ts->version[0] = buf[FW_VERSION_ADDR];
#else
...
#if defined(CONFIG_MACH_MSM8960_L1m) || defined(CONFIG_MACH_MSM8960_L1v)
	if(lge_get_board_revno() < HW_REV_B){
		// rev.A board uses Melfas
		ts->cdev.version = (char *)kmalloc(2,GFP_KERNEL);
		*(ts->cdev.version) = ts->version[0];
	}
#else

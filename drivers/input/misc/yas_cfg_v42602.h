...
#define YAS_MAG_SETTING_ID                  (0)
#ifdef CONFIG_TARGET_PRODUCT_C5155
#ifdef CONFIG_TARGET_PROTOTYPE_WS2
#undef  YAS_MAG_SETTING_ID
#define YAS_MAG_SETTING_ID                  (1)
...
#elif YAS_MAG_SETTING_ID == 1
#define YAS_DEFAULT_MAGCALIB_THRESHOLD      (0)
#define YAS_DEFAULT_MAGCALIB_DISTORTION     (35)
#define YAS_DEFAULT_MAGCALIB_SHAPE          (0)
#define YAS_MAGCALIB_SHAPE_NUM              (2)
#undef YAS_MAG_MANUAL_OFFSET
#else
#error not selected a geomagnetic sensor setting pattern.
#endif /* YAS_MAG_SETTING_ID */

#define YAS_DEFAULT_MAGCALIB_THRESHOLD_LAB  (1)
#define YAS_DEFAULT_MAGCALIB_DISTORTION_LAB (25)
...
#define YAS_MAG_DEFAULT_FILTER_NOISE_X_LAB  (1440) /* sd: 1200 nT */
#define YAS_MAG_DEFAULT_FILTER_NOISE_Y_LAB  (1440) /* sd: 1200 nT */
#define YAS_MAG_DEFAULT_FILTER_NOISE_Z_LAB  (1440) /* sd: 1200 nT */
#define YAS_MAG_DEFAULT_FILTER_LEN_LAB      (30)

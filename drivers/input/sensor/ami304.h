...
#define AMI304_IOCTL_WRITE_CONTROL         _IOW(AMI304IO, 0x07, int)
#define AMI304_IOCTL_WRITE_MODE            _IOW(AMI304IO, 0x08, int)
#else
...
#define AMI304DAE_IOCTL_SET_CONTROL        _IOW(AMI304DAEIO, 0x04, int)
#define AMI304DAE_IOCTL_GET_CONTROL        _IOR(AMI304DAEIO, 0x05, int)
#define AMI304DAE_IOCTL_SET_MODE           _IOW(AMI304DAEIO, 0x06, int)
#define AMI304DAE_IOCTL_SET_REPORT         _IOW(AMI304DAEIO, 0x07, int)
#define AMI304DAE_IOCTL_MAG_OFFSET_ADJ     _IO(AMI304DAEIO, 0x08)
#define AMI304DAE_IOCTL_GET_MAG_OFFSET     _IOW(AMI304DAEIO, 0x09, int)
#define AMI304DAE_IOCTL_SET_MAG_OFFSET     _IOW(AMI304DAEIO, 0x0a, int)
#else
#define AMI304DAE_IOCTL_GET_SENSORDATA     _IOR(AMI304DAEIO, 0x01, int)
#define AMI304DAE_IOCTL_SET_POSTURE        _IOW(AMI304DAEIO, 0x02, int)
#define AMI304DAE_IOCTL_SET_CALIDATA       _IOW(AMI304DAEIO, 0x03, int)

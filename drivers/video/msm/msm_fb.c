 ...
 * 2011-10-20, baryun.hwang@lge.com
 */
static int saved_backlight_level = 156;
#endif
...
static int msm_fb_register(struct msm_fb_data_type *mfd)
{
...
#ifdef	CONFIG_LGE_HIDDEN_RESET
	if (on_hidden_reset)
	msm_iommu_map_contig_buffer(0x88B00000,
					DISPLAY_READ_DOMAIN,
					GEN_POOL,
					fbi->fix.smem_len * 2,
					SZ_4K,
	...
	if (mfd->panel_info.type == MIPI_VIDEO_PANEL ||
		...
		msleep(16); /* Wait for 1 frame delay to avoid glitch while showing LG logo */

...
#define DEFAULT_BACKLIGHT_BRIGHTNESS 139
#endif
					...
					enum led_brightness value)
{
...
#ifdef CONFIG_MACH_MSM8960_L0
	if(value < DEFAULT_BACKLIGHT_BRIGHTNESS) {
		bl_lvl = (2 * value * mfd->panel_info.bl_default + DEFAULT_BACKLIGHT_BRIGHTNESS) / (2 * DEFAULT_BACKLIGHT_BRIGHTNESS);
	} else if(value == DEFAULT_BACKLIGHT_BRIGHTNESS) {
		bl_lvl = mfd->panel_info.bl_default;
	} else if(value > DEFAULT_BACKLIGHT_BRIGHTNESS) {
		bl_lvl = mfd->panel_info.bl_default;
		bl_lvl += (2 * (value - DEFAULT_BACKLIGHT_BRIGHTNESS) * (mfd->panel_info.bl_max - mfd->panel_info.bl_default)+ 
					(MAX_BACKLIGHT_BRIGHTNESS - DEFAULT_BACKLIGHT_BRIGHTNESS)) 
					/ (2 * (MAX_BACKLIGHT_BRIGHTNESS - DEFAULT_BACKLIGHT_BRIGHTNESS));
	}
#else
	...
	/*printk("%s() : value is : %d, bl_lvl is : 0x%x\n", __func__, value, bl_lvl);*/

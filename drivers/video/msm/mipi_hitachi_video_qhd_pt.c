...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
 ...
 /* regulator */
	...
	/* timing */
	{0x66, 0x26, 0x1F, 0x00, 0x22, 0x97, 0x1E, 0x90,
	0x22, 0x03, 0x04, 0xa0},
    /* phy ctrl */
	...
	/* pll control */
	{0x00, 0xE2, 0x01, 0x1A, 0x00, 0x50, 0x48, 0x63,
	0x41, 0x0f, 0x03, 0x00, 0x14, 0x03, 0x00, 0x02,
	0x00, 0x20, 0x00, 0x01 },
#endif
};

static int __init mipi_video_hitachi_qhd_pt_init(void)
{
	int ret;

#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_video_hitachi_qhd"))
		return 0;
#endif
...
/*As per HW engineer comment, Changing DSI Bit clock to 500MHz.*/
/*kiran.kanneganti@lge.com*/
#ifdef CONFIG_MACH_MSM8960_L1m	
	pinfo.clk_rate = 500000000;
#else
	pinfo.clk_rate = 483470000;
#endif
...
module_init(mipi_video_hitachi_qhd_pt_init);

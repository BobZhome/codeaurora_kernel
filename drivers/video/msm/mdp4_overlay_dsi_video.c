...
/*LGE_START_S: Kiran.Kanneganti@lge.com. 03-Jul-2012*/
/*Use mdp4_overlay_dsi_video_start function to TURN ON Overlay block.
It updates dsi_video_enabled variable & prevents multiple turn On.*/
#if 0
...
#endif
/*LGE_START_E: Kiran.Kanneganti@lge.com. 03-Jul-2012*/
		#endif
		if (display_on != NULL) {
			msleep(50);
			display_on(pdev);

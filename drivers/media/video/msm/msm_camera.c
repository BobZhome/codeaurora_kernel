...
/*=============================================================================
 ...
 番号                日付      変更者          コメント
------------------   --------  --------------  --------------------------------
G01-SWD0143-00001    11/10/14  T.Shimizu       カメラWS1対応
G02-SWD0118-00026    12/05/09  t.katsuda       カメラ起動中サスペンドロック対応
G02-SWD0135-00031    12/05/11  N.Koyama        controlイベント待ち時のシグナル割込み抑止対応
=============================================================================*/
		...
		int timeout)
{
	...
	rc = wait_event_interruptible_timeout(
			...
			timeout);
#ifdef FEATURE_KYOCERA_MCAM
    }while(rc==-ERESTARTSYS);  /* G02-SWD0135-00031 ADD */
#endif /* FEATURE_KYOCERA_MCAM */
...
/* G02-SWD0118-00026 ADD-S */
#ifdef FEATURE_KYOCERA_MCAM
        wake_unlock(&sync->wake_lock_suspend);
#endif /* FEATURE_KYOCERA_MCAM */
/* G02-SWD0118-00026 ADD-E */
...
#ifdef FEATURE_KYOCERA_MCAM /* G01-SWD0143-00001 ADD-S */
#else /* FEATURE_KYOCERA_MCAM */
	rc = msm_camio_probe_on(pdev);
	if (rc < 0) {
		wake_lock_destroy(&sync->wake_lock);
		return rc;
	}
#endif /* FEATURE_KYOCERA_MCAM *//* G01-SWD0143-00001 ADD-E */

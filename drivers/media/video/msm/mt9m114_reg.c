...
struct mt9m114_i2c_reg_conf const preview_size_vga_tbl_sub[]=
{
	// VGA size (640*480)
	{0x098E, 0x4868}, 	// LOGICAL_ADDRESS_ACCESS [CAM_OUTPUT_WIDTH]
	{0xC868, 0x0280}, 	// CAM_OUTPUT_WIDTH
	{0xC86A, 0x01E0}, 	// CAM_OUTPUT_HEIGHT
	{0xC85C, 0x03}, 	// CAM_CROP_CROPMODE
	...
	{0xC914, 0x0000}, 	// CAM_STAT_AWB_CLIP_WINDOW_XSTART
	{0xC916, 0x0000}, 	// CAM_STAT_AWB_CLIP_WINDOW_YSTART
	{0xC918, 0x027F}, 	// CAM_STAT_AWB_CLIP_WINDOW_XEND
	{0xC91A, 0x01DF}, 	// CAM_STAT_AWB_CLIP_WINDOW_YEND
	{0xC91C, 0x0000}, 	// CAM_STAT_AE_INITIAL_WINDOW_XSTART
	{0xC91E, 0x0000}, 	// CAM_STAT_AE_INITIAL_WINDOW_YSTART
	{0xC920, 0x007F}, 	// CAM_STAT_AE_INITIAL_WINDOW_XEND
	{0xC922, 0x005F}, 	// CAM_STAT_AE_INITIAL_WINDOW_YEND
	{0xDC00, 0x28}, 	// SYSMGR_NEXT_STATE
	{0x0080, 0x8002}, 	// COMMAND_REGISTER
};

struct mt9m114_i2c_reg_conf const preview_size_full_tbl_sub[]=
{
	// Full size (1280*960)
	{0x098E, 0x4868}, 	// LOGICAL_ADDRESS_ACCESS [CAM_OUTPUT_WIDTH]
...
struct mt9m114_reg mt9m114_regs = {
	...
	/* Preview size */
	.preview_size_vga_tbl = &preview_size_vga_tbl_sub[0],
	.preview_size_vga_tbl_size = ARRAY_SIZE(preview_size_vga_tbl_sub),
	.preview_size_full_tbl = &preview_size_full_tbl_sub[0],
	.preview_size_full_tbl_size = ARRAY_SIZE(preview_size_full_tbl_sub),
};

...
/* START : dukyong.kim@lge.com 2012-03-17 Display All SOC 0 ~ 100% */
	...
	|| defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_L_DCM) || defined(CONFIG_MACH_MSM8960_L1sk) || defined(CONFIG_MACH_MSM8960_L1kt) || defined(CONFIG_MACH_MSM8960_L1u)
	...
	batt_soc /= 9160000;
/*START : sungsoo77.kim@lge.com 2012-08-30 Display All SOC 0 ~ 100%(orginal SOC 95%) */
...
//#endif /* FEATURE_LGE_PM_FACTORY_FUEL_GAUGE */
	...
	if (temp > 20)
		...
		newRcomp = startingRcomp + (int)((temp - 20)*tempCoHot/100);
			...
			|| defined(CONFIG_MACH_MSM8960_D1LSK) || defined(CONFIG_MACH_MSM8960_D1LKT) || defined(CONFIG_MACH_MSM8960_L1sk) || defined(CONFIG_MACH_MSM8960_L1kt) || defined(CONFIG_MACH_MSM8960_L1u)|| defined(CONFIG_MACH_MSM8960_L1m)
...
int max17043_set_operation(void)
{
	...
	if (lge_battery_info == BATT_DS2704_N || lge_battery_info == BATT_DS2704_L ||
		lge_battery_info == BATT_ISL6296_N || lge_battery_info == BATT_ISL6296_L || lge_battery_info >= 0)
	{
...
/* 20111222, hiro.kwon@lge.com, fuel gauge not working without batt [END] */
/*We can schedule it after 2 sec, so that it not interrupt LCD On process */
/* It improves LCD on time. Kiran.kanneganti@lge.com*/
#ifdef CONFIG_MACH_MSM8960_L1m
	schedule_delayed_work(&chip->work, 2 * HZ /*HZ/2*/ );
#else

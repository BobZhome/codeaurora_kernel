...
static struct i2c_registry l_dcm_i2c_pm_subsystem __initdata = {
...
static void __init lge_add_i2c_pm_subsystem_devices(void)
{
	...
	i2c_register_board_info(l_dcm_i2c_pm_subsystem.bus,
				l_dcm_i2c_pm_subsystem.info,
				l_dcm_i2c_pm_subsystem.len);
}
